    ...
    init (isReset) {
      ...
      switch (this.placement) {
        ...
        case 'bottom':
          ...
          break
        case 'rightbottom':
          this.position.right = document.body.clientWidth-trigger.offsetLeft-popover.offsetWidth/2;
          this.position.top = trigger.getBoundingClientRect().top + trigger.offsetHeight + this.gutter;
          break
        default:
  ...
  computed: {
    arrowClass () {
      return {
        ...
        'vux-popover-arrow-up-right': this.placement === 'rightbottom'
      }
    }
  }
}
